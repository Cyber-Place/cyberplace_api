...
//export const url = '172.17.0.2'
const url$3 = 'host.docker.internal';
//export const url = 'localhost'
const port$3 = '3030';
const entryPoint$3 = 'shopping-cart';
...
const resolvers$4 = {
	...
	Mutation: {
		createShoppingList: (_, {shoppingList}) => {
			return generalRequest(`${URL$4}`, 'POST', shoppingList);
		},
		updateShoppingList: (_, {id,shoppingList}) => {
			return generalRequest(`${URL$4}/${id}`, 'PATCH', shoppingList);
		},
